...
<head>
    ...
    <link rel="stylesheet" href="${base}/webjars/bootstrap/2.3.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="${base}/webjars/bootstrap/2.3.2/css/bootstrap-responsive.min.css">
